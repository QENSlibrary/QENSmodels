...
class TestGaussianModel3D(unittest.TestCase):
    ...
    def test_type_size_hwhm_gaussian_model_3d_q_array(self):
        ...
        vector_to_test_hwhm1 = [
            ...
            3.3,    3.63,  3.96, 4.29,  4.62,   4.95,  5.28,  5.61,  5.94, 6.27,
            6.6,    6.93,  7.26,  7.59,  7.92,  8.25,  8.58,  8.91,  9.24, 9.57,
            9.9,   10.23, 10.56, 10.89, 11.22, 11.55, 11.88, 12.21, 12.54,
            12.87, 13.20, 13.53, 13.86, 14.19, 14.52, 14.85, 15.18, 15.51,
            15.84, 16.17, 16.50, 16.83, 17.16, 17.49, 17.82, 18.15, 18.48,
            18.81, 19.14, 19.47, 19.80, 20.13, 20.46, 20.79, 21.12, 21.45,
            21.78, 22.11, 22.44, 22.77, 23.10, 23.43, 23.76, 24.09, 24.42,
            24.75, 25.08, 25.41, 25.74, 26.07, 26.40, 26.73, 27.06, 27.39,
            27.72, 28.05, 28.38, 28.71, 29.04, 29.37, 29.70, 30.03, 30.36,
            30.69, 31.02, 31.35, 31.68, 32.01, 32.34, 32.67]
