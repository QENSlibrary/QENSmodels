...
if sys.argv[1] == 'BrownianTranslationalDiffusion':
    ...
    print ("")
    hwhm, eisf, qisf = qens_models.hwhmBrownianTranslationalDiffusion(q, D)
    ...
    print ("")
    hwhm, eisf, qisf = qens_models.hwhmJumpTranslationalDiffusion(q, D, resTime)
    ...
    print ("")
    hwhm, eisf, qisf = qens_models.hwhmIsotropicRotationalDiffusion(q, R, DR)
